...
@endif
    ...
    <div class="flex-none w-full max-w-full px-3">
        <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                    ...
                    <form role="form" method="POST" action="{{route('dashboard.project.issue.store')}}" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="">
                        ...
                        placeholder="Issue Name" aria-label="Issue" autocomplete="off" aria-describedby="Issue-addon" name="name" value="{{old('name')}}" require/>
                        @if($errors->has('name'))
                      ...
                      <div class="mb-10">
                        ...
                        placeholder="Description Issue" autocomplete="off" aria-label="Description" aria-describedby="description-addon" name="description" value="{{old('description')}}" require/>
