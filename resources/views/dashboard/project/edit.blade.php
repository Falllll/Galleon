...
@endif
    ...
    <div class="flex-none w-full max-w-full px-3">
        <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                    ...
                    <form role="form" method="POST" action="{{route('dashboard.project.update', $project->id)}}">
                      @method('PUT')
                      @csrf
                      ...
                      <div class=" justify-between grid-cols-6 gap-4 my-3">
                            <div class="relative">
                                ...
                                dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 {{ $errors->has('proposal_date') ? ' is-invalid' : '' }}"
                                    ...
                                    placeholder="Select date" value="{{old('proposal_date', $project->proposal_date)}}" require>
                            </div>
