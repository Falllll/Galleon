...
@section('content')
    ...
    <div class="flex-none w-full max-w-full px-3">
        <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                    ...
                    <form role="form" method="POST" action="{{route('dashboard.customer.store')}}">
                      @csrf
                      ...
                      <div class="mb-4">
                        ...
                        placeholder="Customer phone" aria-label="phone" aria-describedby="phone-addon" name="phone" value="{{old('phone')}}" require/>
                        @if($errors->has('phone'))
